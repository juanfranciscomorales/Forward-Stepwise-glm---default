combinacion.modelos.voting <- function (x = tabla.sensibilidad.ordenadas, cant.modelos = 10) { #funcion donde x es el resultado de la funcion del script de curvas ROC.R y cant.modelos es la cant de modelos que quiero combinar
...
combinacion.modelos.voting(x = tabla.sensibilidad.ordenadas, cant.modelos = 10) # funcion para lm
...
clasificaciones.test.set.ensemble.voting.glm <- function (test.set = "Dtest.xlsx",cant.modelos = 10, x = tabla.AUC.ordenadas.glm){
...
clasificaciones.test.set.ensemble.voting.glm(test.set = "Dtest.xlsx",cant.modelos = 10, x = tabla.AUC.ordenadas.glm)
